...
## Corpus Check
- 34 files · ~69,068 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 150 nodes · 201 edges · 15 communities (8 shown, 7 thin omitted)
...
- [[_COMMUNITY_ParallaxCity.tsx|ParallaxCity.tsx]]
...
Cohesion: 0.17
Nodes (11): gsap, SceneCanvas, BOOT_LINES, Loader(), Phase, ENTRIES, Experience(), Hero() (+3 more)

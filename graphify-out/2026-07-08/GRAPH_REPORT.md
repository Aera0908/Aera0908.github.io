...
## Corpus Check
- 44 files · ~2,924,593 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 190 nodes · 291 edges · 17 communities (12 shown, 5 thin omitted)
...
Cohesion: 0.13
Nodes (22): ArchiveItem, ARTS_PENDING, ProjectArchivePage(), SYSTEMS, ResumePreviewModal(), StickyDownloadButton(), SceneCanvas, HudAudioContext (+14 more)

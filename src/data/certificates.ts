...
export const certificatesData: Certificate[] = [
  ...
  },
  {
    ...
    issuer: 'Anthropic',
    description: 'Foundations of the Model Context Protocol, building custom MCP servers, and data integration.',
  ...
  },
  {
    ...
    issuer: 'Anthropic',
    description: 'Advanced transport protocols, security schemas, and enterprise deployment of MCP architectures.',

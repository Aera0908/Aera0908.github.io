...
const Hero = () => {
  ...
  return (
    <section id="home" className="py-12 lg:py-16">
      ...
      >
        <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-emerald-500/40 bg-emerald-500/10 px-3 py-1 font-mono text-[11px] tracking-wider text-emerald-300">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg font-semibold text-sm border border-slate-500 text-slate-300 hover:bg-white/5 transition-colors"
          ...
          <a
            href={emailHref}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg font-semibold text-sm bg-blue-600/15 border border-blue-500/40 text-blue-300 hover:bg-blue-600/25 transition-colors"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
